...
Page({
  ...
  handPlus: function(e){
    ...
    _blocks.push({'index': _order, 'value': ''});//map数组，index和内容
    _blocks.sort(function(a, b){return a.index-b.index;})//按index排序
    this.setData({
      'blocks': _blocks//赋值回去
    })
  },
...
//下降
  ...
  _handTextInput: function(index){
    ...
    this.setData({'blocks': blocks})//先绑定动画
  ...
  formSubmit: function(e){
    ...
    let type = this.data.typeArray[this.data.index].id;
    var content='';
    var summary='';
    var containImgpath='';
